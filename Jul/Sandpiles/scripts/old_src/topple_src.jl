...
function simulate_sandpile(size::Tuple{Int, Int} = (10,10); t_max::Int = prod(size)*4, drop_placement::String = "center", plot::String = "none")
    ...
    if plot != "none"
        ...
        Average_height_points = Observable([Point2f(pile.stats.age, pile.stats.mass)])
    ...
    for i in 1:t_max
        ...
        if plot == "realtime"
            ...
            obs_grid[] = pile.Grid
            Average_height_points[] = push!(Average_height_points[], (pile.stats.age, pile.stats.mass))
