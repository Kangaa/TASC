...
## Results
The performance of the naive stabilisation algorithm was tested on a 101x101 lattice with $k=4$ grains. The number of topplings required to stabilise the lattice was recorded for each $n$ in the range $3 < n < 100$. The results are shown in figure .
