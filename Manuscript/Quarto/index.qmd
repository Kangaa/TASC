...
subtitle: A comparison of Python and Julia in the context of the Abelian Sandpile Model
engine: julia
authors:
...
### Different Toppling Algorithms
![Execution time for different toppling algorithms](figures/topple_algos_benchmark.png)

## Properties of the Sandpile

![Distribution of avalanche sizes in the abelian sandpile model at different grid sizes](figures/topple_freqs.png)

![OLS coefficients for topple size and frequency bu lattice size](figures/slope_vs_size.png)
